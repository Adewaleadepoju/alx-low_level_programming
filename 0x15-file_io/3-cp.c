...
/**
 * create_buffer - Allocate a bytes of 1024 for the buffer
...
/**
 * close_file - Close file descriptors page
 * @fd: The file descriptor to which is be closed
 */
...
/**
 * main - Copies the contents of a particular file to another file
